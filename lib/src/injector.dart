...
import 'package:codehub/src/data/repositories/github_repository_impl.dart';
...
serviceLocator() async {
  ...
  getIt.registerSingleton<GithubRepository>(GithubRepositoryImpl(getIt()));
  getIt.registerSingleton<GetGithubProfileUsecase>(
      GetGithubProfileUsecase(getIt()));
}
